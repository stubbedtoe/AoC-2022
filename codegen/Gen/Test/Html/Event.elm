module Gen.Test.Html.Event exposing (annotation_, blur, call_, check, click, custom, doubleClick, expect, expectNotPreventDefault, expectNotStopPropagation, expectPreventDefault, expectStopPropagation, focus, input, moduleName_, mouseDown, mouseEnter, mouseLeave, mouseOut, mouseOver, mouseUp, simulate, submit, toResult, values_)

{-| 
@docs values_, call_, annotation_, focus, blur, submit, check, input, mouseOut, mouseOver, mouseLeave, mouseEnter, mouseUp, mouseDown, doubleClick, click, custom, expectNotPreventDefault, expectPreventDefault, expectNotStopPropagation, expectStopPropagation, toResult, expect, simulate, moduleName_
-}
...
-}
expectStopPropagation : Elm.Expression -> Elm.Expression
expectStopPropagation expectStopPropagationArg =
    Elm.apply
        (Elm.value
            { importFrom = [ "Test", "Html", "Event" ]
            , name = "expectStopPropagation"
            , annotation =
                Just
                    (Type.function
                        [ Type.namedWith
...
-}
expectNotStopPropagation : Elm.Expression -> Elm.Expression
expectNotStopPropagation expectNotStopPropagationArg =
    Elm.apply
        (Elm.value
            { importFrom = [ "Test", "Html", "Event" ]
            , name = "expectNotStopPropagation"
            , annotation =
                Just
                    (Type.function
                        [ Type.namedWith
...
-}
expectPreventDefault : Elm.Expression -> Elm.Expression
expectPreventDefault expectPreventDefaultArg =
    Elm.apply
        (Elm.value
            { importFrom = [ "Test", "Html", "Event" ]
            , name = "expectPreventDefault"
            , annotation =
                Just
                    (Type.function
                        [ Type.namedWith
...
-}
expectNotPreventDefault : Elm.Expression -> Elm.Expression
expectNotPreventDefault expectNotPreventDefaultArg =
    Elm.apply
        (Elm.value
            { importFrom = [ "Test", "Html", "Event" ]
            , name = "expectNotPreventDefault"
            , annotation =
                Just
                    (Type.function
                        [ Type.namedWith
...
values_ :
    ...
    , expectStopPropagation : Elm.Expression
    , expectNotStopPropagation : Elm.Expression
    , expectPreventDefault : Elm.Expression
    , expectNotPreventDefault : Elm.Expression
