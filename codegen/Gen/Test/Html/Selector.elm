module Gen.Test.Html.Selector exposing (all, annotation_, attribute, call_, checked, class, classes, containing, disabled, exactClassName, exactText, id, moduleName_, selected, style, tag, text, values_)

{-| 
@docs values_, call_, annotation_, disabled, selected, checked, style, exactClassName, classes, class, id, all, attribute, containing, exactText, text, tag, moduleName_
-}
...
exactText: String -> Test.Html.Selector.Selector
-}
exactText : String -> Elm.Expression
exactText exactTextArg =
    Elm.apply
        (Elm.value
            { importFrom = [ "Test", "Html", "Selector" ]
            , name = "exactText"
...
call_ :
    ...
    , exactText : Elm.Expression -> Elm.Expression
